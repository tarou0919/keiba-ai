...
if tab == "🔮 予想する":
    ...
    tmpl = pd.DataFrame({
        "horse_name":["馬名A","馬名B","馬名C"], "jockey":["騎手","騎手","騎手"],
        "odds":[3.5,5.0,8.0], "age":[4,5,6], "weight_carried":[57,57,55],
        "horse_weight":[490,480,470], "weight_change":[0,2,-2], "trainer":["調教師","調教師","調教師"],
    })
    st.download_button(
        "📄 テンプレートをダウンロード",
